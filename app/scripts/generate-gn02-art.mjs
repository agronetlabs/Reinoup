...
const scenes = {
  ...
  '02-voz-serpente': 'A quiet conversation in a lush orchard. The adult woman stands beside a fruit tree looking thoughtfully at a small green snake resting on a low branch. The adult man stands nearby. Both keep their hands at their sides. Show expressive, thoughtful faces. Golden late-afternoon light, flowers, detailed bark and a softly receding garden. Frame all three characters clearly.',
...
Preserve the reference character identities, facial features, skin tone, curly dark hair and short beard of the adult man, long wavy dark hair of the adult woman, and their cream/sand woven clothing with blue and orange sashes. These are adult people. Preserve the high-end stylized 3D rendering, tactile textures and natural light.
...
const textPrompt = `An original 3D animated storybook illustration, landscape 1536x1024. Two adult gardeners: a warm brown-skinned man with short curly dark hair, a short beard, cream knee-length woven tunic, blue sash and sandals; and a warm brown-skinned woman with long wavy dark hair, full-length sand-colored woven dress, orange sash and sandals. Expressive stylized faces, richly detailed textures, warm cinematic light, natural landscapes and a family-friendly mood. ${scenes[scene]} Keep faces and action central, with a clear readable composition. No text, logos or interface.`;
...
const report = {
  scene, model, prompt: textOnly ? textPrompt : prompt,
